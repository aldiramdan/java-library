...
public class AuthorController {
    ...
    public ResponseEntity<ResponseData> create(@Valid @RequestBody AuthorRequest request) {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('ADMIN')")
    public ResponseEntity<ResponseData> update(@PathVariable Long id, @Valid @RequestBody AuthorRequest request) {
