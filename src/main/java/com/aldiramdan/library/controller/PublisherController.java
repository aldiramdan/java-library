...
public class PublisherController {
    ...
    public ResponseEntity<ResponseData> create(@Valid @RequestBody PublisherRequest request) {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('ADMIN')")
    public ResponseEntity<ResponseData> update(@PathVariable Long id, @Valid @RequestBody PublisherRequest request) {
