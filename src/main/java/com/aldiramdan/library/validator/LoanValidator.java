...
public class LoanValidator {
    public void validateLoanNotFound(Optional<Loan> findLoan) {
        if (findLoan.isEmpty()) {
            throw new NotFoundException("Book Loan is not found!");
        }
    }

    public void validateLoanIsAlreadyDeleted(Optional<Loan> findLoan) {
    ...
    public void validateLoanIsAlreadyRecovery(Optional<Loan> findLoan) {
